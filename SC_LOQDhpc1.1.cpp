...
/*
  ...
  ******************************************************
  ...
  To complile
  Windows
c++ -I .\eigen SC_LOQDhpc1.1.cpp iotrans.cpp def.cpp -o SC_LOQDhpc1.1.exe -std=c++0x
  Linux
  
  hpc
c++ -I .\eigen -O3 SC_LOQDhpc1.1.cpp iohpc.cpp def.cpp -o SC_LOQDhpc1.1b.exe
-O
-O2
-O3 better
-Os
...
icpc -I .\eigen -O3 SC_LOQDhpc1.1.cpp iohpc.cpp def.cpp -o SC_LOQDhpc1.1a.exe
-O1
-O2
-O3 best
-xO
